...
csc /nologo /warn:0 /t:library /out:ClassLib.j4n.dll /recurse:clr\*.cs  /reference:"ClassLib.dll" /reference:"jni4net.n-0.8.8.0.dll"
IF %ERRORLEVEL% NEQ 0 goto end
